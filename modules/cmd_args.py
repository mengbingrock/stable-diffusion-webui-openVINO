...
parser.add_argument("--use_openvino", action='store_true', help="whether to prepare openvino inference backend", default=True)
parser.add_argument("--reinstall_torch", action='store_true', help="whether to reinstall torch", default=False)
